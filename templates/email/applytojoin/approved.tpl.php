...
<br><br>
Get started with <strong><?=\Idno\Core\site()->config()->title?></strong> by logging in:
<br><br>
<div align="center">
    <a href="<?=\Idno\Core\site()->config()->getDisplayURL()?>session/login" style="background-color:#73B2E3;border:1px solid #73B2E3;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:normal;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;">Log in</a>
</div>
<br>
